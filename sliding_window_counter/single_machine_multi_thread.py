...
# The size of each bucket depends on how much elasticity is allowed for the rate limiter
...
class RequestCounters(object):
    ...
    def evictOlderBuckets(self, currentTimestamp):
        ...
        bucketsToBeDeleted = filter(lambda bucket: bucket < oldestValidBucket, self.counts.keys())
...
class SlidingWindowCounterRateLimiter(object):
    ...
    # Default of 100 req/minute Add a new user with a request rate
